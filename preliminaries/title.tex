...
\title{\bf Development and Implementation of a Novel Approach to Detecting Gravitational Waves from Compact Binary Coalescences using Machine Learning}
\author{William Walker Benoit}
% Advisor name, put co-advisors here as well separated by commas
\director{Michael Coughlin}
