...
\caption[Example neural-network prediction and integrated neural-network prediction for a $m_1 = 35 M_\odot, m_2 = 35 M_\odot$ signal injection]{Example neural-network prediction and integrated neural-network prediction for a $m_1 = 35 M_\odot, m_2 = 35 M_\odot$ signal injection. The coalescence time is plotted as the vertical dashed black line. The 0.75\,s gap between coalescence time and the full neural-network activation is due to the whitening filter settle-in time and the placement of injections during training; see Sec.~\ref{aframe_meth_sec:noise-sampling}.}\label{aframe_meth_fig:example-output}
\end{figure}
...
\caption[The fraction of SNR $>$ 8 events detected at different false alarm rates during various weeks across a period of time during O3]{The fraction of SNR $>$ 8 events detected at different false alarm rates during various weeks across a period of time during O3, beginning May 9th, 2019 and ending March 21st, 2020. Errors on detection fraction estimates are smaller than the plotted points.}\label{aframe_meth_fig:sensitivity_over_time}
\end{figure*}
...
\caption[ROC curves for waveforms in different SNR bins in our testing dataset]{ROC curves for waveforms in different SNR bins in our testing dataset, described in Sec.~\ref{aframe_meth_sec:data}. Each bin contains waveforms with SNRs within 0.01 of the given value.}\label{aframe_meth_fig:roc}
\end{figure}
