...
\texttt{AMPLFI} is a PE algorithm based on LFI and was presented in detail in Ref.~\cite{Chatterjee:2024pbj}. 
...
Lastly, in Ref.~\cite{Chatterjee:2024pbj}, \texttt{AMPLFI} was trained with a GPU-accelerated IMRPhenomD approximant~\cite{phenomD}. 
