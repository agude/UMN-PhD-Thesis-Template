...
\node[prod] (pa_post)  at (20.0, 17.2)
  {Wait for AMPLFI\\posteriors\\{\footnotesize up to 10\,s timeout}};
\node[prod] (pa_frac)  at (20.0, 15.4) {Compute source-frame\\masses from posteriors};
\node[prod] (pa_class) at (20.0, 13.8)
  {Classify BBH / BNS / NSBH\\{\footnotesize In O4c, $p_{\mathrm{astro}} = p_{\mathrm{BBH}}$}};
